...
if ( dd_aeh()->is_not_paying() && !dd_aeh()->is_trial() ) {
    ?>
		...
		<div id="test-2" class="col s6">
			<ul class="row">
				<li class="valign-wrapper" style="margin-bottom:15px">
					...
					<span style="margin-left:5px">Adding new/custom file types </span>
				</li>
				<li class="valign-wrapper" style="margin-bottom:15px">
					<i class="material-icons teal-text">check_circle</i>
					<span style="margin-left:5px">Remove version info from files</span>
				</li>
				<li class="valign-wrapper" style="margin-bottom:15px">
					<i class="material-icons teal-text">check_circle</i>
					<span style="margin-left:5px">Enable HTTP (gzip) compression</span>
				</li>
			</ul>
		</div>
		<div id="test-2" class="col s6">
			<ul class="row">
				<li class="valign-wrapper" style="margin-bottom:15px">
					<i class="material-icons teal-text">check_circle</i>
					<span style="margin-left:5px">Prevent Specific files from browser cache</span>
				</li>
				<li class="valign-wrapper" style="margin-bottom:15px">
					<i class="material-icons teal-text">check_circle</i>
					<span style="margin-left:5px">Clear Browser cache for users(beta)</span>
				</li>
				<li class="valign-wrapper" style="margin-bottom:15px">
					<i class="material-icons teal-text">check_circle</i>
					<span style="margin-left:5px">Refresh Browser cache periodically</span>
				</li>
			</ul>
		</div>
		<div class="clearfix" style="clear:both"></div>
