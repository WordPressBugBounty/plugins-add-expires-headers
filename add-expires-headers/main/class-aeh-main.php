...
class AEH_Main
{
    ...
    private function getrules()
    {
        ...
        if ( strstr( strtolower( filter_var( $_SERVER['SERVER_SOFTWARE'], FILTER_UNSAFE_RAW ) ), 'apache' ) ) {
            ...
            if ( strstr( strtolower( filter_var( $_SERVER['SERVER_SOFTWARE'], FILTER_UNSAFE_RAW ) ), 'nginx' ) ) {
                $aiowps_server = 'nginx';
            } else {
                
                if ( strstr( strtolower( filter_var( $_SERVER['SERVER_SOFTWARE'], FILTER_UNSAFE_RAW ) ), 'litespeed' ) ) {
